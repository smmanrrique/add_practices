...
En el cuadro resumen se puede apreciar que el valor mas alto de log L se obtiene con la distribucion Gamma, tambien se puede observar qie los valores mas bajos para AIC y BIC los posee esta misma distribucion.
...
Como se puede apreciar el ajuste mas satisfactorio se obtiene con la distribucion gamma. 
...
R=1000 # Numero replicas bootstrap para determinar la bondad del ajuste Gamma
num=length(datos)
# Valor de cada estadistico para la muestra observada:
