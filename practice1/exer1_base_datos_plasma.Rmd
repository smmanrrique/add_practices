...
## Carga de los datos que se encuentran en BaseDatosPlasmaCompleta.RData
```{r}
load("C:/Users/smmanrrique/3D Objects/unizar/ADD Análisis avanzado de datos/aad_practices/practice1/datasets/BaseDatosPlasmaCompleta.RData")
```
